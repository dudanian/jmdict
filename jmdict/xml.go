...
type Reading struct {
	...
	// TODO need to find a better way to parse this
	// as is, need to check if not empty
...
type Sense struct {
	...
	LanguageSource    []string `xml:"lsource"`
